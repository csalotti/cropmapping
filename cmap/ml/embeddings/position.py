...
class PositionalEncoding(nn.Module):
    def __init__(self, d_model: int, n_head : int = 4, tau: float = 10000.0, max_len: int = 397):
        super().__init__()
        ...
        div_term = torch.exp(torch.arange(0, d_model, 2).float() * (-math.log(tau)/ d_model))# [d_model/2,]
